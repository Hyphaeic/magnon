...
impl EffectiveParams {
    ...
    ///   D_DMI_eff = D_DMI_surface / t                      (interface-only for centrosymmetric vdW)
    ...
    pub fn from_parts(bulk: &BulkMaterial, substrate: &Substrate, geometry: &Geometry) -> Self {
        ...
        Self {
            ...
            gamma: bulk.gamma,
            d_dmi: substrate.d_dmi_surface / t,
